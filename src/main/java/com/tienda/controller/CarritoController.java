...
public class CarritoController {
    ...
    public String listado(Model model) {
        ...
        double tCambio=Double.parseDouble(constanteService.getValorDeAtrubuto("dolar"));
        model.addAllAttributes("totalDolares", (double) (Math.round(totalVenta/tCambio*100))/100);
        model.addAllAttributes("precioDolar", tCambio);
